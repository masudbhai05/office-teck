...
import CardLineChart from "../CardLineChart/CardLineChart";
        ...
        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          <div className="flex items-center p-8 bg-white shadow-md rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Total Employee</span>
            </div>
          </div>
          <div className="flex items-center p-8 bg-white shadow-md rounded-lg">
          ...
          <div className="flex items-center p-8 bg-white shadow-md rounded-lg">
            <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-red-600 bg-red-100 rounded-full mr-6">
              <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" classNameName="h-6 w-6">
            ...
            <div>
              ...
              <span className="block text-gray-500">Running Projects</span>
            </div>
          </div>
          <div className="flex items-center p-8 bg-white shadow-md rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Assets</span>
            </div>
          </div>
        </section>
