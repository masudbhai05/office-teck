...
const AddProjectForm = ({ onClose }) => {
    ...
    const HandleSubmit = (event) => {
        ...
        const addProject = {name, description, projectImage}
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-y-4 mt-4 text-gray-400">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <input type="text" className="rounded-[13px] p-2 mt-2 focus:outline-slate-400 border text-black" placeholder="Project Image Link" id="number" name="projectImage" />
                                    </div>
                                </div>
                            </div>
